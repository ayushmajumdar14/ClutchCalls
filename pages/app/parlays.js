...
const Parlays = () => {
  ...
  return (
    <div style={styles}>
      <nav className="bg-black p-4 text-left">
        <ul className="flex space-x-6" style={{ display: "flex", flexDirection: "row", padding: 0 }}>
          {[
            { href: "/app/parlays", text: "Parlays" },
            { href: "/app/our-story", text: "Our Story" },
            { href: "/app/regulations", text: "Regulations" },
            { href: "/app/the-team", text: "The Team" },
          ].map(({ href, text }, index) => (
            <li key={index}>
              <Link href={href}>
